...
const PlacesFormPage = () => {
  ...
  async function savePlace(e) {
    ...
    if (id) {
      ...
      toast('New accommodation created!')
      setRedirect(true);
    }
  }
...
async function deleteAccommodation (){
  ...
  return (
    <div>
      ...
      {id && <button onClick={deleteAccommodation} className="bg-red-400 p-2 w-full text-white rounded-2xl">Delete Accommodation</button>}
    </div>
  );
};
